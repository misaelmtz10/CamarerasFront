...
self.addEventListener('install', (event) => {
    ...
    const respCache = caches.open(STATIC_CACHE_NAME).then((cache) => {
        return cache.addAll([
            ...
            '/img/crown.png',
            '/img/Corona.ico',
            '/img/icons/Icono-Camarera-48-48.png',
            '/img/icons/Icono-Camarera-72-72.png',
            '/img/icons/Icono-Camarera-96-96.png',
            '/img/icons/Icono-Camarera-192-192.png',
            '/img/icons/Icono-Camarera-144-144.png',
            '/img/icons/Icono-Camarera-512-512.png',
            'manifest.json'
        ])
